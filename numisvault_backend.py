...
def coin_search():
    ...
    for o in offers:
        ...
        _target_denom=str((payload.get("coin") or {}).get("denom") or (payload.get("coin") or {}).get("denomination") or "").strip()
        if _target_denom and denomination_conflicts(_target_denom,o.get("title","")):
