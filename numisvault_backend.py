...
def catalog_admin_auto_tick():
    ...
    # Never overlap catalogue cycles in the same web process. If the previous
    # trigger is still working, the cron call still succeeds immediately.
    if _CATALOG_AUTO_TICK_LOCK.locked():
        with _CATALOG_AUTO_TICK_STATE_LOCK:
